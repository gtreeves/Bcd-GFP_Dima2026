...
%		If this is not specified, but you still want to specify other
%		arguments, put empty brackets -- [] -- in place of this argument.
%	* "bzero_flag": experimental. A flag that, if true, would force b to be
%		equal to zero. If you choose this flag, stats will be messed up.
%
% Outputs:
%	"m": best-fit slope
